...
var franceText = document.getElementById("fr");
...
franceText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var franceCenterX = 1000;
        var franceCenterY = 195;
        ...
        arrowLine.setAttribute("x1", franceCenterX2);
        arrowLine.setAttribute("y1", franceCenterY2);
        ...
        text2.setAttribute("x", 1010);
        text2.setAttribute("y",193);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "1031";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", franceCenterX2);
        arrowLine3.setAttribute("y1", franceCenterY2);
        ...
        text4.setAttribute("y",219);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "1281";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", franceCenterX2);
        arrowLine5.setAttribute("y1", franceCenterY2);
        ...
        text5.setAttribute("x", 988);
        text5.setAttribute("y",212);
        ...
        infoBox.setAttribute("x", 985);
        infoBox.setAttribute("y", 145);
        ...
        infoBox2.setAttribute("x", 1040);
        infoBox2.setAttribute("y", 140);
        ...
        infoBox4.setAttribute("x", 1025);
        infoBox4.setAttribute("y", 222);
        ...
        infoBox5.setAttribute("x", 950);
        infoBox5.setAttribute("y", 241);
        ...
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,004628</p>";

         var infoContent3 = document.createElement("div");
         infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,005075</p>";

         var infoContent4 = document.createElement("div");
         infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,004434</p>";
        ...
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,006120</p>";
