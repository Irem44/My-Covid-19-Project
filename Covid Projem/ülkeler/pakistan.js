...
var pakistanText = document.getElementById("pk");
...
pakistanText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var pakistanCenterX = 1375;
        var pakistanCenterY = 305;
        ...
        arrowLine.setAttribute("x1", pakistanCenterX);
        arrowLine.setAttribute("y1", pakistanCenterY);
        ...
        text1.setAttribute("x", 1385);
        text1.setAttribute("y",320);
        ...
        arrowLine2.setAttribute("x1", pakistanCenterX);
        arrowLine2.setAttribute("y1", pakistanCenterY);
        ...
        text2.setAttribute("x", 1420);
        text2.setAttribute("y",288);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "3283";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", pakistanCenterX);
        arrowLine3.setAttribute("y1", pakistanCenterY);
        ...
        text3.setAttribute("x", 1360);
        text3.setAttribute("y",295);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "425";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", pakistanCenterX);
        arrowLine4.setAttribute("y1", pakistanCenterY);
        ...
        text4.setAttribute("x", 1350);
        text4.setAttribute("y",305);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "1501";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", pakistanCenterX);
        arrowLine5.setAttribute("y1", pakistanCenterY);
        ...
        text5.setAttribute("x", 1335);
        text5.setAttribute("y",330);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "1660";
        ...
        infoBox2.setAttribute("x", 1500);
        infoBox2.setAttribute("y", 280);
        ...
        infoBox3.setAttribute("x", 1320);
        infoBox3.setAttribute("y", 245);
        ...
        infoBox4.setAttribute("x", 1265);
        infoBox4.setAttribute("y", 260);
        ...
        infoBox5.setAttribute("x", 1285);
        infoBox5.setAttribute("y", 370);
        ...
        infoBox6.setAttribute("x", 1350);
        infoBox6.setAttribute("y", 320);
        ...
        var infoContent = document.createElement("div");
         infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000320</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.00000347471</p>";

        var infoContent3 = document.createElement("div");
        infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.0000569</p>";

        var infoContent4 = document.createElement("div");
        infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000886</p>";

        var infoContent5 = document.createElement("div");
        infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000750</p>";

        var infoContent6 = document.createElement("div");
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0.000689</p>";
