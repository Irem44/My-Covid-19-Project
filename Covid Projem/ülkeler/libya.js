...
var libyaText = document.getElementById("29");
...
libyaText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var libyaCenterX = 1085;
        var libyaCenterY = 345;
        var lineEndX =1020;
        var lineEndY =330;
        var lineEndX2 = 1030;
        var lineEndY2 =395;
        ...
        arrowLine.setAttribute("x1", libyaCenterX);
        arrowLine.setAttribute("y1", libyaCenterY);
        ...
        text1.setAttribute("x", 1050);
        text1.setAttribute("y",335);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "1549";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", libyaCenterX);
        arrowLine2.setAttribute("y1", libyaCenterY);
        ...
        text3.setAttribute("x",1080);
        text3.setAttribute("y",370);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "1219";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", libyaCenterX);
        arrowLine4.setAttribute("y1", libyaCenterY);
        ...
        text4.setAttribute("x", 1095);
        text4.setAttribute("y",355);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "2019";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", libyaCenterX);
        arrowLine5.setAttribute("y1", libyaCenterY);
        ...
        text5.setAttribute("x", 1100);
        text5.setAttribute("y",340);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "1349";
        ...
        infoBox.setAttribute("x", 980);
        infoBox.setAttribute("y",290);
        ...
        infoBox2.setAttribute("x", 1010);
        infoBox2.setAttribute("y", 400);
        ...
        infoBox4.setAttribute("x", 1135);
        infoBox4.setAttribute("y", 400);
        ...
        infoBox5.setAttribute("x", 1130);
        infoBox5.setAttribute("y", 340);
        ...
        infoBox6.setAttribute("x",1060);
        infoBox6.setAttribute("y", 300);
        ...
        infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000720</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000003807</p>";

        var infoContent3 = document.createElement("div");
        infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000004422</p>";

        var infoContent4 = document.createElement("div");
        infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,0000139</p>";

        var infoContent5 = document.createElement("div");
        infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,0000486</p>";

        var infoContent6 = document.createElement("div");
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,000720</p>";
