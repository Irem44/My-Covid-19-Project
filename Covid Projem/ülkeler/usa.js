...
var usaText = document.getElementById("us");
var arrowLine = null;
var arrowLine2 = null;
var arrowLine3 = null;
var arrowLine4 = null;
...
usaText.addEventListener("click", function(event) {
    if (!clicked) {
        ...
        arrowLine.setAttribute("x1", usaCenterX2);
        arrowLine.setAttribute("y1", usaCenterY2);
        ...
        text1.setAttribute("x", 455);
        text1.setAttribute("y",220);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "8978";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", usaCenterX2);
        arrowLine2.setAttribute("y1", usaCenterY2);
        ...
        // svg.appendChild(text5);
         ...
         infoBox.setAttribute("x", 450);
         infoBox.setAttribute("y", 110);
         ...
         infoBox2.setAttribute("x", 380);
         infoBox2.setAttribute("y", 355);
         ...
         infoBox3.setAttribute("x", 510);
         infoBox3.setAttribute("y", 360);
         ...
         infoBox4.setAttribute("x", 415);
         infoBox4.setAttribute("y",390);
        ...
        //  infoBox5.setAttribute("font-size","4px");
         ...
         infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,001287</p>";
         
         var infoContent2 = document.createElement("div");
         infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000585</p>";

         var infoContent3 = document.createElement("div");
         infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000986</p>";

         var infoContent4 = document.createElement("div");
         infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000694</p>";

        //  var infoContent5 = document.createElement("div");
        //  infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı</p><p style='text-align: center;'>1339782</p>";

         var infoContent6 = document.createElement("div");
         infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,003338</p>";
        ...
        // infoContent5.style.cssText = "background-color: green; border: 1px solid black; padding: 4px; border-radius:6px";
        ...
        clicked = true;
         ...
         if (arrowLine && arrowLine2 && arrowLine3 &&  arrowLine4 && text1  && text2  && text3  && text4/*   && arrowLine5   && text3  && text5*/) {
            arrowLine.remove();
            arrowLine2.remove();
            arrowLine3.remove();
            arrowLine4.remove();
        ...
        if (infoBox  && infoBox2 && infoBox3  && infoBox4 && infoBox6/*  && infoBox4 && infoBox5 && infoBox6*/) {
            infoBox.remove();
            infoBox2.remove();
            infoBox3.remove();
            infoBox4.remove();
