...
var fasText = document.getElementById("3");
...
fasText.addEventListener("click", function(event) {
    if (!clicked) {
        ...
        arrowLine.setAttribute("x1", fasCenterX);
        arrowLine.setAttribute("y1", fasCenterY);
        ...
        text1.setAttribute("x", 950);
        text1.setAttribute("y",285);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "1220";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", fasCenterX);
        arrowLine2.setAttribute("y1", fasCenterY);
        ...
        text2.setAttribute("x", 970);
        text2.setAttribute("y",280);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "1341";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", fasCenterX);
        arrowLine3.setAttribute("y1", fasCenterY);
        ...
        text5.setAttribute("x", 990);
        text5.setAttribute("y",300);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "2433";
        ...
        infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,005564</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,002978</p>";

        var infoContent3 = document.createElement("div");
        infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000957</p>";

        var infoContent4 = document.createElement("div");
        infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,00000596</p>";
        ...
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,000338</p>";
