...
var boliviaText = document.getElementById("6");
...
boliviaText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var boliviaCenterX =620;
        var boliviaCenterY =630;
        var lineEndX =570;
        var lineEndY =580;
        var lineEndX2 =690;
        var lineEndY2 =580;
        ...
        arrowLine.setAttribute("x1", boliviaCenterX);
        arrowLine.setAttribute("y1", boliviaCenterY);
        ...
        text1.setAttribute("x",580);
        text1.setAttribute("y",590);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "1468";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", boliviaCenterX);
        arrowLine2.setAttribute("y1", boliviaCenterY);
        ...
        text2.setAttribute("y",600);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "1271";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", boliviaCenterX);
        arrowLine3.setAttribute("y1", boliviaCenterY);
        ...
        text3.setAttribute("x", 630);
        text3.setAttribute("y",635);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "959";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", boliviaCenterX);
        arrowLine4.setAttribute("y1", boliviaCenterY);
        ...
        arrowLine5.setAttribute("x1", boliviaCenterX);
        arrowLine5.setAttribute("y1", boliviaCenterY);
        ...
        text5.setAttribute("x", 613);
        text5.setAttribute("y",680);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "3017";
        ...
        infoBox3.setAttribute("x", 675);
        infoBox3.setAttribute("y", 630);
        ...
        infoBox4.setAttribute("x", 615);
        infoBox4.setAttribute("y", 730);
        ...
        infoBox6.setAttribute("x", 605);
        infoBox6.setAttribute("y", 575);
        ...
        var infoContent = document.createElement("div");
         infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'> 0,001357</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,001796</p>";
        ...
        infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,001146</p>";
         ...
         infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,002193</p>";
        ...
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,001010</p>";
