...
var argentinText = document.getElementById("ar");
...
argentinText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var argentinCenterX =630;
        var argentinCenterY =680;
        var lineEndX =605;
        var lineEndY =725;
        var lineEndX2 =680;
        var lineEndY2 =711;
        ...
        arrowLine.setAttribute("x1", argentinCenterX);
        arrowLine.setAttribute("y1", argentinCenterY);
        ...
        text1.setAttribute("x",610);
        text1.setAttribute("y",700);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "1133";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", argentinCenterX);
        arrowLine2.setAttribute("y1", argentinCenterY);
        ...
        text2.setAttribute("x", 645);
        text2.setAttribute("y",690);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "1244";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", argentinCenterX);
        arrowLine3.setAttribute("y1", argentinCenterY);
        ...
        text3.setAttribute("x", 640);
        text3.setAttribute("y",675);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "1735";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", argentinCenterX);
        arrowLine4.setAttribute("y1", argentinCenterY);
        ...
        text4.setAttribute("x", 625);
        text4.setAttribute("y",660);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "2866";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", argentinCenterX);
        arrowLine5.setAttribute("y1", argentinCenterY);
        ...
        text5.setAttribute("x", 665);
        text5.setAttribute("y",605);
        ...
        infoBox.setAttribute("x", 545);
        infoBox.setAttribute("y", 715);
        ...
        infoBox2.setAttribute("x",695);
        infoBox2.setAttribute("y", 695);
        ...
        infoBox3.setAttribute("x", 670);
        infoBox3.setAttribute("y", 615);
        ...
        infoBox4.setAttribute("x", 610);
        infoBox4.setAttribute("y", 577);
        ...
        infoBox5.setAttribute("x", 725);
        infoBox5.setAttribute("y", 560);
        ...
        infoBox6.setAttribute("x", 625);
        infoBox6.setAttribute("y", 735);
        ...
        var infoContent = document.createElement("div");
         infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,002793</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,002977</p>";

         var infoContent3 = document.createElement("div");
         infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,001146</p>";
        ...
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,002193</p>";
