...
var indiaText = document.getElementById("in");
...
indiaText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var indiaCenterX = 1440;
        var indiaCenterY = 335;
        var indiaCenterX2=1430;
        var indiaCenterY2=350;
        var lineEndX =1380;
        var lineEndY =315;
        var lineEndX2 = 1440;
        var lineEndY2 =324;
        ...
        arrowLine.setAttribute("x1", indiaCenterX);
        arrowLine.setAttribute("y1", indiaCenterY);
        ...
        text1.setAttribute("x", 1390);
        text1.setAttribute("y",317);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "1452";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", indiaCenterX);
        arrowLine2.setAttribute("y1", indiaCenterY);
        ...
        text2.setAttribute("x", 1428);
        text2.setAttribute("y",327);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "1012";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", indiaCenterX);
        arrowLine3.setAttribute("y1", indiaCenterY);
        ...
        text4.setAttribute("x", 1443);
        text4.setAttribute("y",331);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "1934";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", indiaCenterX);
        arrowLine5.setAttribute("y1", indiaCenterY);
        ...
        text5.setAttribute("x", 1425);
        text5.setAttribute("y",400);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "2439";
        ...
        infoBox.setAttribute("x", 1295);
        infoBox.setAttribute("y", 300);
        ...
        infoBox2.setAttribute("x", 1415);
        infoBox2.setAttribute("y", 290);
        ...
        infoBox3.setAttribute("x", 1450);
        infoBox3.setAttribute("y", 352);
        ...
        infoBox4.setAttribute("x", 1490);
        infoBox4.setAttribute("y", 310);
        ...
        infoBox5.setAttribute("x", 1360);
        infoBox5.setAttribute("y", 330);
        ...
        var infoContent = document.createElement("div");
         infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000689</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000331</p>";

         var infoContent3 = document.createElement("div");
         infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000122</p>";

         var infoContent4 = document.createElement("div");
         infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000795</p>";

         var infoContent5 = document.createElement("div");
         infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000320</p>";

        var infoContent6 = document.createElement("div");
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0.000311</p>";
        ...
        infoContent5.style.cssText = "background-color: #ec5353; border: 1px solid black; padding: 4px; border-radius:  10px";
        infoContent6.style.cssText = "background-color: #b56d5b;  padding: 4px; border-radius:10px";
