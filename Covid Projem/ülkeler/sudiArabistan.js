...
var sudiText = document.getElementById("17");
...
sudiText.addEventListener("click", function(event) {
    if (!clicked) {
        ...
        arrowLine.setAttribute("x1", sudiCenterX);
        arrowLine.setAttribute("y1", sudiCenterY);
        ...
        text1.setAttribute("x", 1205);
        text1.setAttribute("y",325);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "1645";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", sudiCenterX);
        arrowLine2.setAttribute("y1", sudiCenterY);
        ...
        text2.setAttribute("x", 1225);
        text2.setAttribute("y",325);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "1526";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", sudiCenterX);
        arrowLine3.setAttribute("y1", sudiCenterY);
        ...
        text3.setAttribute("x",1195);
        text3.setAttribute("y",345);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "1469";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", sudiCenterX);
        arrowLine4.setAttribute("y1", sudiCenterY);
        ...
        text4.setAttribute("x", 1203);
        text4.setAttribute("y",360);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "1986";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", sudiCenterX);
        arrowLine5.setAttribute("y1", sudiCenterY);
        ...
        text5.setAttribute("x", 1230);
        text5.setAttribute("y",370);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "993";
        ...
        infoBox5.setAttribute("x", 1235);
        infoBox5.setAttribute("y", 403);
        ...
        infoBox6.setAttribute("x",1265);
        infoBox6.setAttribute("y", 340);
        ...
        infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000584</p>";
        ...
        infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,0000486</p>";
        ...
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,000234</p>";
