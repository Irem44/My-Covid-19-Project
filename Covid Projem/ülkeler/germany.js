...
var germanyText = document.getElementById("gr");
...
germanyText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var germanyCenterX = 1040;
        var germanyCenterY = 185;
        ...
        arrowLine.setAttribute("x1", germanyCenterX);
        arrowLine.setAttribute("y1", germanyCenterY);
        ...
        text1.setAttribute("x", 1027);
        text1.setAttribute("y",182);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "539";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", germanyCenterX);
        arrowLine2.setAttribute("y1", germanyCenterY);
        ...
        text2.setAttribute("x", 1028);
        text2.setAttribute("y",191);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "661";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", germanyCenterX);
        arrowLine3.setAttribute("y1", germanyCenterY);
        ...
        text3.setAttribute("x", 1004);
        text3.setAttribute("y",189);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "1031";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", germanyCenterX);
        arrowLine4.setAttribute("y1", germanyCenterY);
        ...
        text4.setAttribute("x", 1041);
        text4.setAttribute("y",192);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "686";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", germanyCenterX);
        arrowLine5.setAttribute("y1", germanyCenterY);
        ...
        text5.setAttribute("x", 1040);
        text5.setAttribute("y",183);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "644";
        ...
        infoBox.setAttribute("x", 965);
        infoBox.setAttribute("y", 150);
        ...
        infoBox2.setAttribute("x", 1000);
        infoBox2.setAttribute("y", 205);
        ...
        infoBox4.setAttribute("x", 1045);
        infoBox4.setAttribute("y", 200);
        ...
        infoBox5.setAttribute("x", 1060);
        infoBox5.setAttribute("y", 150);
        ...
        infoBox6.setAttribute("x", 1010);
        infoBox6.setAttribute("y", 140);
        ...
        var infoContent = document.createElement("div");
         infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,004166</p>";
        ...
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,005075</p>";
         ...
         infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,006120</p>";

         var infoContent4 = document.createElement("div");
         infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,006707</p>";

        var infoContent5 = document.createElement("div");
        infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,004432</p>";

        var infoContent6 = document.createElement("div");
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,004628</p>";
