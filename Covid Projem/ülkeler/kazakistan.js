...
var kazakistanText = document.getElementById("kz");
...
kazakistanText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var kazakistanCenterX = 1370;
        var kazakistanCenterY = 200;
        var lineEndX =1450;
        var lineEndY =100;
        var lineEndX2 = 1473;
        var lineEndY2 =202;
        ...
        arrowLine.setAttribute("x1", kazakistanCenterX);
        arrowLine.setAttribute("y1", kazakistanCenterY);
        ...
        text1.textContent = "2822";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", kazakistanCenterX);
        arrowLine2.setAttribute("y1", kazakistanCenterY);
        ...
        text2.setAttribute("x", 1385);
        text2.setAttribute("y",197);
        ...
        arrowLine3.setAttribute("x1", kazakistanCenterX);
        arrowLine3.setAttribute("y1", kazakistanCenterY);
        ...
        text3.textContent = "3323";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", kazakistanCenterX);
        arrowLine4.setAttribute("y1", kazakistanCenterY);
        ...
        arrowLine5.setAttribute("x1", kazakistanCenterX);
        arrowLine5.setAttribute("y1", kazakistanCenterY);
        ...
        infoBox3.setAttribute("x", 1500);
        infoBox3.setAttribute("y", 280);
        ...
        infoBox4.setAttribute("x", 1290);
        infoBox4.setAttribute("y", 230);
        ...
        infoBox5.setAttribute("x", 1355);
        infoBox5.setAttribute("y", 238);
        ...
        infoBox6.setAttribute("x", 1300);
        infoBox6.setAttribute("y", 160);
        ...
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,002994</p>";
        ...
        infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,0000737</p>";

         var infoContent5 = document.createElement("div");
         infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000307</p>";

        var infoContent6 = document.createElement("div");
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,000735</p>";
