...
var myanmarText = document.getElementById("23");
...
myanmarText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var myanmarCenterX = 1505;
        var myanmarCenterY = 365;
        ...
        arrowLine.setAttribute("x1", myanmarCenterX);
        arrowLine.setAttribute("y1", myanmarCenterY);
        ...
        text1.setAttribute("x", 1515);
        text1.setAttribute("y",290);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "4597";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", myanmarCenterX);
        arrowLine2.setAttribute("y1", myanmarCenterY);
        ...
        text2.setAttribute("x", 1475);
        text2.setAttribute("y",355);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "1083";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", myanmarCenterX);
        arrowLine3.setAttribute("y1", myanmarCenterY);
        ...
        text3.setAttribute("y",360);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "2940";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", myanmarCenterX);
        arrowLine4.setAttribute("y1", myanmarCenterY);
        ...
        text4.setAttribute("x", 1530);
        text4.setAttribute("y",372);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "716";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", myanmarCenterX);
        arrowLine5.setAttribute("y1", myanmarCenterY);
        ...
        text5.setAttribute("x", 1520);
        text5.setAttribute("y",380);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "1273";
        ...
        infoBox2.setAttribute("x", 1460);
        infoBox2.setAttribute("y", 315);
        ...
        infoBox6.setAttribute("x", 1515);
        infoBox6.setAttribute("y", 330);
        ...
        var infoContent = document.createElement("div");
         infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.00000347471</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000122</p>";

        var infoContent3 = document.createElement("div");
        infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000320</p>";

        var infoContent4 = document.createElement("div");
        infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000292</p>";

        var infoContent5 = document.createElement("div");
        infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000680</p>";

        var infoContent6 = document.createElement("div");
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,000116</p>";
