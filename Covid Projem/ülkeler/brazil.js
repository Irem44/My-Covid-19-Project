...
var brazilText = document.getElementById("br");
...
brazilText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var brazilCenterX = 680;
        var brazilCenterY = 580;
        // var franceCenterX2=1000;
        // var franceCenterY2=210;
        var lineEndX =580;
        var lineEndY =475;
        var lineEndX2 =585;
        var lineEndY2 =575;
        ...
        arrowLine.setAttribute("x1", brazilCenterX);
        arrowLine.setAttribute("y1", brazilCenterY);
        ...
        text2.setAttribute("y",575);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "2573";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", brazilCenterX);
        arrowLine3.setAttribute("y1", brazilCenterY);
        ...
        text3.setAttribute("x", 650);
        text3.setAttribute("y",590);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "1271";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", brazilCenterX);
        arrowLine4.setAttribute("y1", brazilCenterY);
        ...
        text4.setAttribute("x", 663);
        text4.setAttribute("y",600);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "1231";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", brazilCenterX);
        arrowLine5.setAttribute("y1", brazilCenterY);
        ...
        text5.setAttribute("x", 680);
        text5.setAttribute("y",600);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "2922";
        ...
        infoBox2.setAttribute("x", 515);
        infoBox2.setAttribute("y", 560);
        ...
        infoBox3.setAttribute("x", 565);
        infoBox3.setAttribute("y", 600);
        ...
        infoBox4.setAttribute("x", 600);
        infoBox4.setAttribute("y", 640);
        ...
        infoBox6.setAttribute("x", 725);
        infoBox6.setAttribute("y", 560);
        ...
        var infoContent = document.createElement("div");
         infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,001242</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,001357</p>";

         var infoContent3 = document.createElement("div");
         infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,001010</p>";

         var infoContent4 = document.createElement("div");
         infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,001146</p>";

         var infoContent5 = document.createElement("div");
         infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,002193</p>";

        var infoContent6 = document.createElement("div");
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,001796</p>";
