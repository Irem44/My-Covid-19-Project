...
var mexicoText = document.getElementById("mx");
...
mexicoText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var mexicoCenterX =410;
        var mexicoCenterY =340;
        var mexicoCenterX2=410;
        var mexicoCenterY2=360;
        var lineEndX =470;
        var lineEndY =250;
        var lineEndX2 =465;
        var lineEndY2 =152;
        ...
        arrowLine.setAttribute("x1", mexicoCenterX2);
        arrowLine.setAttribute("y1", mexicoCenterY2);
        ...
        text1.setAttribute("x", 432);
        text1.setAttribute("y",300);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "3145";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", mexicoCenterX2);
        arrowLine2.setAttribute("y1", mexicoCenterY2);
        ...
        text3.setAttribute("x", 430);
        text3.setAttribute("y",385);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "1057";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", mexicoCenterX2);
        arrowLine4.setAttribute("y1", mexicoCenterY2);
        ...
        text4.setAttribute("x", 430);
        text4.setAttribute("y",370);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "1947";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", mexicoCenterX2);
        arrowLine5.setAttribute("y1", mexicoCenterY2);
        ...
        text5.setAttribute("x", 430);
        text5.setAttribute("y",358);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "2549";
        ...
        infoBox.setAttribute("x", 485);
        infoBox.setAttribute("y", 230);
        ...
        infoBox2.setAttribute("x",450);
        infoBox2.setAttribute("y", 110);
        ...
        infoBox4.setAttribute("x", 455);
        infoBox4.setAttribute("y", 425);
        ...
        infoBox6.setAttribute("x", 360);
        infoBox6.setAttribute("y", 335);
        ...
        var infoContent = document.createElement("div");
         infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'> 0,003338</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,001287</p>";

         var infoContent3 = document.createElement("div");
         infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000694</p>";

         var infoContent4 = document.createElement("div");
         infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000464</p>";

         var infoContent5 = document.createElement("div");
         infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000986</p>";

        var infoContent6 = document.createElement("div");
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0.000585</p>";
