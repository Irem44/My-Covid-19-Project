...
var venezuelaText = document.getElementById("26");
...
venezuelaText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var venezuelaCenterX =625;
        var venezuelaCenterY =460;
        var lineEndX =590;
        var lineEndY =470;
        var lineEndX2 =645;
        var lineEndY2 =465;
        ...
        arrowLine.setAttribute("x1", venezuelaCenterX);
        arrowLine.setAttribute("y1", venezuelaCenterY);
        ...
        text1.setAttribute("x",605);
        text1.setAttribute("y",470);
        ...
        arrowLine2.setAttribute("x1", venezuelaCenterX);
        arrowLine2.setAttribute("y1", venezuelaCenterY);
        ...
        text2.setAttribute("x", 628);
        text2.setAttribute("y",467);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "865";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", venezuelaCenterX);
        arrowLine3.setAttribute("y1", venezuelaCenterY);
        ...
        text3.setAttribute("x", 612);
        text3.setAttribute("y",490);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "1970";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", venezuelaCenterX);
        arrowLine4.setAttribute("y1", venezuelaCenterY);
        ...
        text4.setAttribute("x", 610);
        text4.setAttribute("y",520);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "2546";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", venezuelaCenterX);
        arrowLine5.setAttribute("y1", venezuelaCenterY);
        ...
        text5.setAttribute("x", 643);
        text5.setAttribute("y",520);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "2808";
        ...
        infoBox.setAttribute("x", 515);
        infoBox.setAttribute("y", 460);
        ...
        infoBox2.setAttribute("x",640);
        infoBox2.setAttribute("y", 433);
        ...
        infoBox6.setAttribute("x", 590);
        infoBox6.setAttribute("y", 425);
        ...
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000933</p>";
        ...
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,000188</p>";
