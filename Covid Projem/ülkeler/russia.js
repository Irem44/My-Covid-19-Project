...
var russiaText = document.getElementById("rs");
...
russiaText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var russiaCenterX =1440;
        var russiaCenterY =112;
        var lineEndX =1110;
        var lineEndY =110;
        var lineEndX2 =1145;
        var lineEndY2 =185;
        ...
        arrowLine.setAttribute("x1", russiaCenterX);
        arrowLine.setAttribute("y1", russiaCenterY);
        ...
        text1.setAttribute("y",110);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "3922";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", russiaCenterX);
        arrowLine2.setAttribute("y1", russiaCenterY);
        ...
        text3.setAttribute("x", 1385);
        text3.setAttribute("y",140);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "2822";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", russiaCenterX);
        arrowLine4.setAttribute("y1", russiaCenterY);
        ...
        text4.setAttribute("x", 1450);
        text4.setAttribute("y",155);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "2853";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", russiaCenterX);
        arrowLine5.setAttribute("y1", russiaCenterY);
        ...
        infoBox.setAttribute("x", 1080);
        infoBox.setAttribute("y", 75);
        ...
        infoBox2.setAttribute("x",1120);
        infoBox2.setAttribute("y", 192);
        ...
        infoBox3.setAttribute("x", 1300);
        infoBox3.setAttribute("y", 202);
        ...
        infoBox5.setAttribute("x", 1530);
        infoBox5.setAttribute("y", 185);
        ...
        infoBox6.setAttribute("x", 1410);
        infoBox6.setAttribute("y", 55);
        ...
        var infoContent = document.createElement("div");
         infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'> 0,002729</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,001286</p>";

        var infoContent3 = document.createElement("div");
        infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000735</p>";
         ...
         infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,002994</p>";

        var infoContent6 = document.createElement("div");
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,001651</p>";
        ...
        // CSS stilini uygula
        infoContent.style.cssText = "background-color: #b56d5b;  padding: 4px;border: 1px solid black; border-radius:10px";
        ...
        infoContent6.style.cssText = "background-color: #ec5353; border: 1px solid black; padding: 4px; border-radius:10px";
