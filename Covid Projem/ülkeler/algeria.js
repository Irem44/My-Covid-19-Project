...
var algText = document.getElementById("42");
...
algText.addEventListener("click", function(event) {
    if (!clicked) {
        ...
        arrowLine.setAttribute("x1", algCenterX);
        arrowLine.setAttribute("y1", algCenterY);
        ...
        text4.setAttribute("x", 1005);
        text4.setAttribute("y",375);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "1332";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", algCenterX);
        arrowLine5.setAttribute("y1", algCenterY);
        ...
        infoBox.setAttribute("x", 930);
        infoBox.setAttribute("y",260);
        ...
        infoBox2.setAttribute("x", 900);
        infoBox2.setAttribute("y", 380);
        ...
        infoBox3.setAttribute("x", 955);
        infoBox3.setAttribute("y", 392);
        ...
        infoBox6.setAttribute("x",982);
        infoBox6.setAttribute("y", 290);
        ...
        infoContent.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000338</p>";
         
        var infoContent2 = document.createElement("div");
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000130</p>";

        var infoContent3 = document.createElement("div");
        infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,00001544</p>";

        var infoContent4 = document.createElement("div");
        infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000003807</p>";

        var infoContent5 = document.createElement("div");
        infoContent5.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000720</p>";

        var infoContent6 = document.createElement("div");
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,00000599</p>";
