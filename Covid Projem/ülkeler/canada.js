...
var canadaText = document.getElementById("cn");
...
canadaText.addEventListener("click", function(event) {
    if (!clicked) {
        var point = svg.createSVGPoint();
        point.x = event.clientX;
        point.y = event.clientY;
        var svgPoint = point.matrixTransform(svg.getScreenCTM().inverse());
        var canadaCenterX = 510;
        var canadaCenterY = 150;
        var lineEndX =460;
        var lineEndY =240;
        var lineEndX2 =440;
        var lineEndY2 =342;
        ...
        arrowLine.setAttribute("x1", canadaCenterX);
        arrowLine.setAttribute("y1", canadaCenterY);
        ...
        text1.setAttribute("x", 470);
        text1.setAttribute("y",200);
        text1.setAttribute("fill", "black");
        text1.setAttribute("font-size","5px");
        text1.textContent = "2260";

        arrowLine2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine2.setAttribute("x1", canadaCenterX);
        arrowLine2.setAttribute("y1", canadaCenterY);
        ...
        arrowLine3.setAttribute("x1", canadaCenterX);
        arrowLine3.setAttribute("y1", canadaCenterY);
        ...
        infoBox2.setAttribute("x", 350);
        infoBox2.setAttribute("y", 330);
        ...
        infoBox3.setAttribute("x", 810);
        infoBox3.setAttribute("y", 30);
        ...
        infoBox4.setAttribute("x", 450);
        infoBox4.setAttribute("y", 408);
        ...
        infoBox5.setAttribute("x", 565);
        infoBox5.setAttribute("y", 355);
        ...
        infoBox6.setAttribute("x", 450);
        infoBox6.setAttribute("y", 110);
        ...
        infoContent3.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,002101</p>";
