...
var iranText = document.getElementById("ir");
...
iranText.addEventListener("click", function(event) {
    if (!clicked) {
        ...
        arrowLine.setAttribute("x1", iranCenterX);
        arrowLine.setAttribute("y1", iranCenterY);
        ...
        text2.setAttribute("x", 1250);
        text2.setAttribute("y",290);
        text2.setAttribute("fill", "black");
        text2.setAttribute("font-size","5px");
        text2.textContent = "1286";

        arrowLine3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine3.setAttribute("x1", iranCenterX);
        arrowLine3.setAttribute("y1", iranCenterY);
        ...
        text3.setAttribute("x",1300);
        text3.setAttribute("y",283);
        text3.setAttribute("fill", "black");
        text3.setAttribute("font-size","5px");
        text3.textContent = "2221";

        arrowLine4 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine4.setAttribute("x1", iranCenterX);
        arrowLine4.setAttribute("y1", iranCenterY);
        ...
        text4.setAttribute("x", 1300);
        text4.setAttribute("y",295);
        text4.setAttribute("fill", "black");
        text4.setAttribute("font-size","5px");
        text4.textContent = "2438";

        arrowLine5 = document.createElementNS("http://www.w3.org/2000/svg", "line");
        arrowLine5.setAttribute("x1", iranCenterX);
        arrowLine5.setAttribute("y1", iranCenterY);
        ...
        text5.setAttribute("x", 1260);
        text5.setAttribute("y",305);
        text5.setAttribute("fill", "black");
        text5.setAttribute("font-size","5px");
        text5.textContent = "1526";
        ...
        infoBox2.setAttribute("x", 1160);
        infoBox2.setAttribute("y", 275);
        ...
        infoBox4.setAttribute("x", 1350);
        infoBox4.setAttribute("y", 315);
        ...
        infoContent2.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0,000584</p>";
        ...
        infoContent4.innerHTML = "<p style='text-align: center;'>Vaka Sayısı/Nüfus</p><p style='text-align: center;'>0.000689</p>";
        ...
        infoContent6.innerHTML = "<p style='text-align:center;'>Vaka Sayısı/Nüfus: 0,000886</p>";
